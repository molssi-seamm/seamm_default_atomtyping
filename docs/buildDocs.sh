...
do
	...
	sphinx-apidoc -o docs/developer seamm_default_atomtyping
...
<html>
   <head>
      <title>Documentation for the seamm_default_atomtyping plug-in for SEAMM</title>
   </head>
   <body>
      <h1>Documentation for the seamm_default_atomtyping plug-in for SEAMM</h1>
      <h2>Branches</h2>
      <ul>
EOF
