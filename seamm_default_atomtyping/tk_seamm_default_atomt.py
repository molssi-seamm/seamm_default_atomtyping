...
"""The graphical part of a seamm_default_atomtyping step"""
...
class TkSeammDefaultAtomtyping(seamm.TkNode):
    """
    The graphical part of a seamm_default_atomtyping step in a flowchart.
    ...
    self[widget] : dict
        ...
        contained in seamm_default_atomtyping_parameters.py

    See Also
    --------
    SeammDefaultAtomtyping, TkSeammDefaultAtomtyping,
    SeammDefaultAtomtypingParameters,
    """
    ...
    def create_dialog(self):
        ...
        based on what is specified in the seamm_default_atomtyping_parameters
        module.
        ...
        See Also
        --------
        TkSeammDefaultAtomtyping.reset_dialog
        """

        frame = super().create_dialog(title='seamm_default_atomtyping')
    ...
    def reset_dialog(self, widget=None):
        ...
        seamm_default_atomtyping_parameter.
        ...
        See Also
        --------
        TkSeammDefaultAtomtyping.create_dialog
        """
    ...
    def edit(self):
        """Present a dialog for editing the seamm_default_atomtyping input
        ...
        See Also
        --------
        TkSeammDefaultAtomtyping.right_click
        """
    ...
    def handle_help(self):
        ...
        None
        """
        print('Help not implemented yet for seamm_default_atomtyping!')
