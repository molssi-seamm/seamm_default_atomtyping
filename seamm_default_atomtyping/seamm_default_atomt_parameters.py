# -*- coding: utf-8 -*-
"""
Control parameters for the seamm_default_atomtyping step in a SEAMM flowchart
"""
...
class SeammDefaultAtomtypingParameters(seamm.Parameters):
    """
    ...
    See Also
    --------
    SeammDefaultAtomtyping, TkSeammDefaultAtomtyping, SeammDefaultAtomtyping
    SeammDefaultAtomtypingParameters, seamm_default_atomtypingStep
    ...
    def __init__(self, defaults={}, data=None):
        ...
        logger.debug('SeammDefaultAtomtypingParameters.__init__')

        super().__init__(
            defaults={**SeammDefaultAtomtypingParameters.parameters, **defaults},
            data=data
        )
